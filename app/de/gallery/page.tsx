import Section from '@/app/component/gallerySec';
            ...
            <div className="p-2 w-full h-full">
                <div className="w-full ">
                    <div className="grid gap-x-5 grid-rows-3 w-full">
                        <Section sectionName="Unterkünfte" url1="/img/rooms/1.jpg" url2="/img/rooms/2.jpg" url3="/img/rooms/3.jpg" url4="/img/rooms/4.jpg" url5="/img/rooms/5.jpg" url6="/img/rooms/6.jpg" />
