    ...
    <div className=" w-full ">
        ...
        <div className="flex flex-wrap">
          ...
          <div className="w-full lg:w-1/2 pb-5 flex lg:justify-start 2xl:justify-start" >
            <img src="/img/okoli/lipnice.jpg" className="w-full rounded-[25px] lg:w-2/3 2xl:w-2/3" alt=" Hrad Lipnice v Lipnici nad Sázavou" title="Kamenný strážce Posázaví, hrad Lipnice v Lipnici nad Sázavou"/>
          </div>
        </div>
        ...
        <div className="flex flex-wrap">
          ...
          <div className="w-full lg:w-1/2 pb-5 flex lg:justify-end 2xl:justify-end" >
            <img src="/img/okoli/nmnm.jpg" className="w-full rounded-[25px] lg:w-2/3 2xl:w-2/3" alt="Bialton v Novém Městě na Moravě" title="Každoroční mistrovstí světa v Bialtonu v Novém Městě na Moravě"/>
          </div>
        </div>
        ...
        <div className="flex flex-wrap">
          ...
          <div className="w-full lg:w-1/2 pl-5 pb-5 flex lg:justify-start 2xl:justify-start" >
            <img src="/img/okoli/vysoka.jpg" className="w-full rounded-[25px] lg:w-2/3 2xl:w-2/3" alt="Ski areál Vysoká" title="Ski areál Vysoká u Havlíčkova Brodu"/>
          </div>
        </div>
        ...
        <div className="flex flex-wrap">
          ...
          <div className="w-full  lg:w-1/2 pb-5 flex lg:justify-end 2xl:justify-end " >
            <img src="/img/okoli/iglau.jpg" className="w-full rounded-[25px] lg:w-2/3 2xl:w-2/3" alt="Krajské město Jihlava" title="Krajské město Jihlava odkud pochází např. 58g"/>
          </div>
        </div>
